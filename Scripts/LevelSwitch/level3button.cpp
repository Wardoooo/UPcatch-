...
{
	startwhen_start_button_3 = GetSelf<Button>(instance);
	if (startwhen_start_button_3)
	{
		startwhen_start_button_3->connect("pressed", callable_mp_static(&startwhen_OnButtonPressed));
	}
}
